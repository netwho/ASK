...
Prompt-ApiKey -ServiceName "AlienVault OTX" -FileName "OTX_API_KEY.txt" -Url "https://otx.alienvault.com" -Required "optional"

Prompt-ApiKey -ServiceName "Abuse.ch (URLhaus/ThreatFox)" -FileName "ABUSECH_API_KEY.txt" -Url "https://auth.abuse.ch" -Required "optional"
...
$Keys = @(
    ...
    @{Name="AlienVault OTX"; File="OTX_API_KEY.txt"},
    @{Name="Abuse.ch (URLhaus/ThreatFox)"; File="ABUSECH_API_KEY.txt"}
)
