...
prompt_api_key "AlienVault OTX" "OTX_API_KEY.txt" "https://otx.alienvault.com" "optional"

prompt_api_key "Abuse.ch (URLhaus/ThreatFox)" "ABUSECH_API_KEY.txt" "https://auth.abuse.ch" "optional"
...
if [ -f "$CONFIG_DIR/OTX_API_KEY.txt" ]; then
    echo "  ✓ AlienVault OTX"
else
